...
public class DataInputStream extends FilterInputStream implements DataInput {
     ...
     */
    // 从包装的输入流读取足量的字节填充给定的字节数组，返回实际填充的字节数
     ...
     * @see java.io.FilterInputStream#in
     */
    // 从包装的输入流读取足量的字节填充给定的字节数组，填不满不返回
     ...
     * @see java.io.FilterInputStream#in
     */
    // 从包装的输入流读取len个字节插入到字节数组b的off处，读不够len个字节不返回
     ...
     */
    // 从指定的输入流读取UTF8格式的字节，将其解码为String
